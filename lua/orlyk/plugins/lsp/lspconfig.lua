...
local on_attach = function(client, bufnr)
    ...
    keymap.set("n", "<leader>lg", "<cmd>Lspsaga outline<CR>", opts) -- see outline on right hand side
    keymap.set("n", "<leader>ff", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts) -- see outline on right hand side
